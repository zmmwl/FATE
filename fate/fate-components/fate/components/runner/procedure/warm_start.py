...
from fate.interface import Dataframe, ModelsLoader, ModelsSaver, Module, Context, Params
...
class WarmStart(Procedure):
    ...
    def run(
        ...
        if TrainWithValidate.is_fulfilled(params, datasets, models_loader):
            TrainWithValidate.run(ctx, cpn, params, datasets, models_loader, models_saver)
        elif TrainWithoutValidate.is_fulfilled(params, datasets, models_loader):
            TrainWithoutValidate.run(ctx, cpn, params, datasets, models_loader, models_saver)
